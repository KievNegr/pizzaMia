    ...
    <div class="padding">
        ...
        <?php
            foreach($listGoods as $category):
                    if($category['parent'] != 0 && !empty($category['goods']) && $category['deleted'] != 1):
        ?>
                ...
                <div class="select-size">
                    ...
                    ?>
                        <div class="size">
                            ...
                            <?php if($item['online_order'] == 1): ?>
                            <button class="btn btn-dark fast-value" itemid="<?php echo $item['id']; ?>" optionid="<?php echo $option['id']; ?>"  title="Добавить в корзину <?php echo $item['title']; ?>">
                                <i class="fas fa-cart-arrow-down"></i>
                            </button>
                            <?php else: ?>
                            <button class="btn btn-dark" style="padding: 3px 10px 1px 7px;" disabled title="<?php echo $item['title']; ?> недоступен для online заказа">
                                <i class="fas fa-cart-arrow-down"></i>
                            </button>
                            <?php endif;?>
                        </div>
