...
<body>
    ...
    <div id="wrapper">  
        ...
        <div class="wrapper">
            <div class="sidebar">
                <p class="phone">+38(063)254-64-08</p>
                                ...
                                <div class="col orderlist">
                                    ...
                                    ?>
                                        <div class="list list<?php echo $list['id_option']; ?>">
                                            ...
                                            <div class="link">
                                                <?php echo Html::a($list['product_name'], Url::to(['goods/index', 'sef' => $list['product_sef']]), ['target' => '_blank']); ?></a>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            ...
                            <p class="text-info">
                                <?php echo Yii::$app->session->getFlash('orderDate'); ?>
                            </p>
                        ...
                        <div class="col">
                            <?php if(!empty(Yii::$app->session->getFlash('payCard'))): ?>
                                <div class="ordered_card">
                                    <p>Уважаемый клиент, вы выбрали оплату банковской картой, для совершения оплаты нажмите кнопку "Оплатить".</p>
                                    <h6 class="modal-order">Сумма к оплате: <?php echo Yii::$app->session->getFlash('paySum') . ' ' . $this->params['currency']['name']; ?></h6>
                                    <div class="button-pay">
                                        <?php echo Yii::$app->session->getFlash('payCard'); ?>
                                    </div>
                                </div>
                            <?php endif;?>
        ...
        <?php if(Yii::$app->session->getFlash('success-register')): ?>
            <div class="alert alert-warning alert-dismissible fade show registered" role="alert">
                <h4 class="alert-heading">Спасибо за регистрацию!</h4>
                <p>Вы успешно зарегистрировались, используйте свой email и пароль для входа на сайт.</p>
